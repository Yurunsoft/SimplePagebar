 ...
 */
var SimplePagebar = (function () {
    function SimplePagebar(option) {
        this.container = null;
        this.element = null;
        this.pages = 0;
        this.currPage = 1;
    ...
    SimplePagebar.prototype.display = function () {
        var _this = this;
        ...
        this.element = $('<div class="simple-pagebar">\
            <a class="sp-first"></a>\
            <a class="sp-prev"></a>\
        ...
        this.element.find('.sp-prev')
            .on('click', function () {
            _this.goto(Math.max(1, _this.currPage - 1));
            _this.setPageShowText();
        })
            .html(this.prev);
        this.element.find('.sp-next')
            .on('click', function () {
            _this.goto(Math.min(_this.pages, _this.currPage + 1));
            _this.setPageShowText();
        })
            .html(this.next);
        ...
        this.element.find('.sp-page')
            ...
            if (e.which == 13) {
                ...
                $(e.currentTarget).val(_this.currPage);
                $(e.currentTarget).blur();
            }
        });
        this.setPageShowText();
    };
    SimplePagebar.prototype.goto = function (page) {
        if (page < 0) {
            page = 1;
        }
    ...
    SimplePagebar.prototype.setPageShowText = function () {
    ...
    SimplePagebar.isFirstLoad = true;
    SimplePagebar.currPath = '';
...
;
(function (exports) {
    var doc = exports.document, a = {}, expose = +new Date(), rExtractUri = /((?:http|https|file):\/\/.*?\/[^:]+)(?::\d+)?:\d+/, isLtIE8 = ('' + doc.querySelector).indexOf('[native code]') === -1;
...
//# sourceMappingURL=SimplePagebar.js.map